...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $shop_ip = empty($_POST['shop_ip']) ? '' : trim($_POST['shop_ip']);
    $shop_id = empty($_POST['shop_id']) ? '' : trim($_POST['shop_id']);
    $shop_name = empty($_POST['shop_name']) ? '' : trim($_POST['shop_name']);
    $shop_city_no = empty($_POST['shop_city_no']) ? '' : trim($_POST['shop_city_no']);
    $shop_url = empty($_POST['shop_url']) ? '' : trim($_POST['shop_url']);
    $shop_alipay_parterID = empty($_POST['shop_alipay_parterID']) ? '' : trim($_POST['shop_alipay_parterID']);
    $shop_alipay_sellerID = empty($_POST['shop_alipay_sellerID']) ? '' : trim($_POST['shop_alipay_sellerID']);
    $shop_alipay_RSAPublic = empty($_POST['shop_alipay_RSAPublic']) ? '' : trim($_POST['shop_alipay_RSAPublic']);
    $shop_alipay_RSAPrivate = empty($_POST['shop_alipay_RSAPrivate']) ? '' : trim($_POST['shop_alipay_RSAPrivate']);
    $shop_alipay_callUrl = empty($_POST['shop_alipay_callUrl']) ? '' : trim($_POST['shop_alipay_callUrl']);
    ...
    $other['shop_ip'] = $shop_ip;
    $other['shop_id'] = $shop_id;
    $other['shop_name'] = $shop_name;
    $other['shop_city_no'] = $shop_city_no;
    $other['shop_url'] = $shop_url;
    $other['shop_alipay_parterID'] = $shop_alipay_parterID;
    $other['shop_alipay_sellerID'] = $shop_alipay_sellerID;
    $other['shop_alipay_RSAPublic'] = $shop_alipay_RSAPublic;
    $other['shop_alipay_RSAPrivate'] = $shop_alipay_RSAPrivate;
    $other['shop_alipay_callUrl'] = $shop_alipay_callUrl;
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    u.office_phone, u.home_phone, u.mobile_phone, u.shop_ip, u.shop_id, u.shop_name, u.shop_city_no, u.shop_url, u.shop_alipay_parterID, u.shop_alipay_sellerID, u.shop_alipay_RSAPublic, u.shop_alipay_RSAPrivate, u.shop_alipay_callUrl".
        " FROM " .$ecs->table('users'). " u LEFT JOIN " . $ecs->table('users') . " u2 ON u.parent_id = u2.user_id WHERE u.user_id='$_GET[id]'";
    ...
    if ($row)
    {
        ...
        $user['shop_ip'] = $row['shop_ip'];
        $user['shop_id'] = $row['shop_id'];
        $user['shop_name'] = $row['shop_name'];
        $user['shop_city_no'] = $row['shop_city_no'];
        $user['shop_url'] = $row['shop_url'];
        $user['shop_alipay_parterID'] = $row['shop_alipay_parterID'];
        $user['shop_alipay_sellerID'] = $row['shop_alipay_sellerID'];
        $user['shop_alipay_RSAPublic'] = $row['shop_alipay_RSAPublic'];
        $user['shop_alipay_RSAPrivate'] = $row['shop_alipay_RSAPrivate'];
        $user['shop_alipay_callUrl'] = $row['shop_alipay_callUrl'];
    }
    else
    {
          $link[] = array('text' => $_LANG['go_back'], 'href'=>'users.php?act=list');
...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT user_id, user_name, email, shop_ip, is_validated, user_money, frozen_money, rank_points, pay_points, reg_time ".
